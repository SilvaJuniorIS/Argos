...
frontend/
  argos-web/ aplicacao React + Vite atual
...
A menor arquitetura viavel e evoluir a API FastAPI existente dentro de `backend/app`, adicionando um modulo isolado para o ARGOS. O frontend atual fica preservado em `frontend/argos-web` e pode receber uma nova area de navegacao para processos, geracao de documentos e exportacao.
