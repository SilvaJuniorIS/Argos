...
- `tipo_instrumento=contrato|ata_registro_preco`
- `page`
- `limit`
- `numero`
- `q`
...
## Contratos e atas com mesmo numero

O numero deixa de ser unico globalmente. A regra de unicidade passa a ser composta:

```text
tipo_instrumento + numero
```

Assim, estes dois registros podem coexistir:

```text
contrato           001/2026
ata_registro_preco 001/2026
```

No frontend, `/contratos` filtra `tipo_instrumento=contrato` e `/atas` filtra `tipo_instrumento=ata_registro_preco`.
