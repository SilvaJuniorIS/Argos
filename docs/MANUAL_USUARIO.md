...
O ARGOS é uma plataforma para gestão, fiscalização e inteligência documental de contratos e licitações públicas.
...
Com isso, o ARGOS deixa de ser apenas base técnica e passa a operar o ciclo completo de cadastro, acompanhamento e alerta.
