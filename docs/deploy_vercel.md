...
- Root Directory: `frontend/fiscalbot-web`
...
O arquivo `frontend/fiscalbot-web/vercel.json` direciona rotas do app React para `index.html`, evitando erro 404 ao abrir URLs como:
