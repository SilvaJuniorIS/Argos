...
def create_contrato(
    ...
    *,
    ...
    if contrato_repository.get_by_tipo_numero(db, data["tipo_instrumento"], data["numero"]):
        raise ValueError("Ja existe instrumento deste tipo com este numero")
...
def update_contrato(
    ...
    *,
    ...
    tipo = updates.get("tipo_instrumento", contrato.tipo_instrumento)
    numero = updates.get("numero", contrato.numero)
    if contrato_repository.get_by_tipo_numero(db, tipo, numero, exclude_id=contrato.id):
        raise ValueError("Ja existe instrumento deste tipo com este numero")
